...
// Fetch is yet browser-specific api, so we need to import isomorphic fetch
...
async function fetchBeerAndTurnIntoNodes({
  ...
  for (const beer of beers) {
    // When you make node, you also need to define metadata!
    const nodeMeta = {
      // making unique id
      ...
      internal: {
        ...
        // watch whether the data has changed or not
...
async function turnSlicemastersIntoPages({ graphql, actions }) {
  ...
  data.slicemasters.nodes.forEach((slicemaster) => {
    actions.createPage({
      component: resolve('./src/templates/Slicemasters.js'),
  ...
  console.log(`There are ${data.slicemasters.totalCount} total count
